...
dMVC.router = router.get('/', function(req, res, next) {

    var lastID = req.get('Last-Event-ID');
    console.log('Last-Event-ID: ', lastID);
    if(lastID) {
        delete dMVC.streams[lastID];
    }
    res.writeHead(200, {
        'Content-Type': 'text/event-stream; charset=utf-8',
        'Cache-Control': 'no-cache'
    });
    var id = _.uniqueId('stream_');
    res.write('data: ' + JSON.stringify({streamID: id}) + '\n\n');
    res.write('id: ' + id + '\n\n');
    dMVC.streams[id] = res;
